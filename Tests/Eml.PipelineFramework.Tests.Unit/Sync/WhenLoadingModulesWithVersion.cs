...
using Eml.PipelineFramework.Tests.Unit.Modules;
using Eml.PipelineFramework.Tests.Unit.Modules2;
    ...
    public class WhenLoadingModulesWithVersion : IntegrationTestBase
    {
        ...
        public void Pipeline_ShouldUnloadAllDiscoveredModules()
        {
            ...
            dotMemory.Check(memory =>
            {
                ...
                memory.GetObjects(where => where.Type.Is<FakePipeline.FakePipeline>()).ObjectsCount.ShouldBe(0);
            });
        }
